...
import RichTextElement, { RichTextElementSpecificProps } from "@arteneo/forge/components/Form/elements/RichTextElement";
import TextFieldPlaceholderInterface from "@arteneo/forge/components/Form/definitions/TextFieldPlaceholderInterface";

type RichTextProps = RichTextElementSpecificProps & TextFieldPlaceholderInterface;
...
const RichText = ({
    ...
    if (typeof name === "undefined") {
        throw new Error("RichText component: name is required prop. By default it is injected by FormContent.");
    }
