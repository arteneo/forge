...
const DialogFormView = ({
    ...
    // Using DialogFormViewProps typing definition that allows only label OR only children to be defined
    ...
    if (children === undefined && label === undefined) {
        throw new Error("DialogFormView component: Missing children or label prop");
    }

    if (children !== undefined && label !== undefined) {
        throw new Error("DialogFormView component: It is not possible to use children and label prop at the same time");
    }
